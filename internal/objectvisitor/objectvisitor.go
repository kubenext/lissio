...
//go:generate mockgen -destination=./fake/mock_object_handler.go -package=fake -self_package github.com/kubenext/lissio/internal/objectvisitor/fake github.com/kubenext/lissio/internal/objectvisitor ObjectHandler
//go:generate mockgen -destination=./fake/mock_default_typed_visitor.go -package=fake github.com/kubenext/lissio/internal/objectvisitor DefaultTypedVisitor
//go:generate mockgen -destination=./fake/mock_typed_visitor.go -package=fake github.com/kubenext/lissio/internal/objectvisitor TypedVisitor
//go:generate mockgen -destination=./fake/mock_visitor.go -package=fake github.com/kubenext/lissio/internal/objectvisitor Visitor
