...
//go:generate mockgen -destination=./fake/mock_manager.go -package=fake github.com/kubenext/lissio/internal/module ManagerInterface
//go:generate mockgen -destination=./fake/mock_action_registrar.go -package=fake github.com/kubenext/lissio/internal/module ActionRegistrar
