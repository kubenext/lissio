...
//go:generate mockgen -source=namespace.go -destination=./fake/mock_namespace_interface.go -package=fake github.com/kubenext/lissio/internal/cluster NamespaceInterface
