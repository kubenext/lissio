...
//go:generate mockgen -destination=./fake/mock_manager.go -package=fake github.com/kubenext/lissio/pkg/plugin ManagerInterface
//go:generate mockgen -destination=./fake/mock_module_registrar.go -package=fake github.com/kubenext/lissio/pkg/plugin ModuleRegistrar
//go:generate mockgen -destination=./fake/mock_action_registrar.go -package=fake github.com/kubenext/lissio/pkg/plugin ActionRegistrar
