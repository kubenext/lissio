...
//go:generate mockgen -destination=./fake/mock_dashboard_client.go -package=fake github.com/kubenext/lissio/pkg/plugin/api/proto DashboardClient
//go:generate mockgen -destination=./fake/mock_dashboard_connection.go -package=fake github.com/kubenext/lissio/pkg/plugin/api DashboardConnection
